package dev.itssho.module.component.components.select
...
class ButtonCollection(val buttons: List<JToggleButton>) {
    ...
    init {
        buttons.forEachIndexed { i, btn ->
            btn.collection = this
            btn.model = XToggleButtonModel { newState -> (selectedIndex != i || (selectedIndex == i && newState == true)) }
