...
class IdeaKtsScriptRunnerFactory(private val scriptEngineManager: IdeScriptEngineManager) : ScriptRunnerFactory {
	...
	override fun get(): ScriptRunner {
		...
		val engine = scriptEngineManager.getEngine(engineInfo, null) ?: throw IllegalStateException("Engine info was found, but script engine is absent. $engineInfo. $generalInfo")
